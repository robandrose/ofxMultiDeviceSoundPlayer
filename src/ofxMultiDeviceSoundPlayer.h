...
class ofxMultiDeviceSoundPlayer 
{
	...
	public:
		...
		void	setSpeakerMix(float _frontleft, float _frontright, float _center, float _lfe, float _backleft, float _backright);
		void	setSpeakerAndVolume(int _speaker, float _volume);
		...
		float 	pan;				// 0 - 1
		float frontleft, frontright, center, lfe, backleft, backright, sideleft, sideright;
		float 	volume;				// 0 - 1
